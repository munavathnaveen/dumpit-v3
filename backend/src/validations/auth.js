...
const registerSchema = Joi.object({
    ...
    role: Joi.string().valid(config.constants.userRoles.VENDOR, config.constants.userRoles.CUSTOMER).default(config.constants.userRoles.CUSTOMER),
...
const loginSchema = Joi.object({
    ...
    role: Joi.string().valid(config.constants.userRoles.VENDOR, config.constants.userRoles.CUSTOMER).required().messages({
