...
const RegisterScreen: React.FC = () => {
    ...
    const renderStepOne = () => (
        <>
            ...
            <Button title="Continue" onPress={role === "vendor" ? validateStep1 : handleRegister} loading={loading} style={styles.button} />
        </>
    );
    ...
    const renderStepTwo = () => (
        <>
            ...
            <Input label="Shop Name" value={shopData.shopName} onChangeText={(text) => handleShopChange("shopName", text)} placeholder="Enter your shop name" error={validationErrors.shopName} />
            ...
            <View style={styles.buttonContainer}>
                <Button title="Back" onPress={() => setCurrentStep(1)} style={[styles.button, styles.backButton]} textStyle={styles.backButtonText} outline />
                <Button title="Register" onPress={handleRegister} loading={loading} style={[styles.button, styles.registerButton]} />
            </View>
        </>
    );
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                <View style={styles.container}>
                    ...
                    <Card3D style={styles.card} elevation="medium">
                        ...
                        <View style={styles.form}>{currentStep === 1 ? renderStepOne() : renderStepTwo()}</View>
