            ...
            <View style={styles.gradientBackground}>
                <View style={styles.successContainer}>
                    ...
                    <Card3D style={styles.successCard}>
                        ...
                        <Text style={styles.successText}>Your password has been successfully reset. You will be redirected to the login screen.</Text>
                    </Card3D>
                </View>
            </View>
        );
        ...
        <View style={styles.container}>
            <View style={styles.content}>
                ...
                <Card3D style={styles.card}>
                    ...
                    {token ? (
                        <>
                            <Input label="New Password" value={password} onChangeText={setPassword} placeholder="Enter new password" secureTextEntry error={errors.password} />
                        ...
                        <View style={styles.tokenMissingContainer}>
                            <Text style={styles.tokenMissingText}>No reset token found. Please use the reset link from your email.</Text>
                        </View>
                    )}
