            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                <View style={styles.container}>
                    ...
                    <Card3D style={styles.card} elevation="medium">
                        ...
                        <RoleTabSelector selectedRole={role} onRoleChange={setRole} />
                        ...
                        <View style={styles.form}>
                            ...
                            <Button title={`Login as ${role === "vendor" ? "Vendor" : "Customer"}`} onPress={handleLogin} loading={loading} style={styles.button} />
                        </View>
