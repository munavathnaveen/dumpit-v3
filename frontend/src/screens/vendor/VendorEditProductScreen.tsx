...
const productCategories = ["Electronics", "Clothing", "Home & Kitchen", "Beauty & Personal Care", "Books", "Sports & Outdoors", "Toys & Games", "Health & Wellness", "Grocery", "Other"];
...
const VendorEditProductScreen: React.FC = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (response.success) {
                alert("Success", "Product updated successfully", [{ text: "OK", onPress: () => navigation.goBack() }]);
            } else {
    ...
    return (
        <View style={styles.container}>
            ...
            <KeyboardAwareScrollView contentContainerStyle={styles.contentContainer} enableOnAndroid={true} keyboardShouldPersistTaps="handled">
                <Card3D style={styles.formCard} elevation="medium">
                    ...
                    <View style={styles.formField}>
                        ...
                        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.categoriesContainer}>
                            {productCategories.map((category) => (
                                <TouchableOpacity
                                    key={category}
                                    style={[styles.categoryChip, formData.category === category && styles.selectedCategoryChip]}
                                    onPress={() => handleInputChange("category", category)}
                                >
                                    <Text style={[styles.categoryChipText, formData.category === category && styles.selectedCategoryChipText]}>{category}</Text>
                                </TouchableOpacity>
                            ))}
                        </ScrollView>
                    </View>
                    ...
                    <View style={styles.formField}>
                        ...
                        <View style={styles.statusContainer}>
                            <TouchableOpacity style={[styles.statusButton, formData.isActive && styles.activeStatusButton]} onPress={() => handleInputChange("isActive", true)}>
                                <Ionicons name="checkmark-circle" size={20} color={formData.isActive ? theme.colors.white : theme.colors.dark} />
                                <Text style={[styles.statusButtonText, formData.isActive && styles.activeStatusButtonText]}>Active</Text>
                            </TouchableOpacity>

                            <TouchableOpacity style={[styles.statusButton, !formData.isActive && styles.inactiveStatusButton]} onPress={() => handleInputChange("isActive", false)}>
                                <Ionicons name="pause-circle" size={20} color={!formData.isActive ? theme.colors.white : theme.colors.dark} />
                                <Text style={[styles.statusButtonText, !formData.isActive && styles.inactiveStatusButtonText]}>Inactive</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </Card3D>
                ...
                <TouchableOpacity style={styles.submitButton} onPress={handleSubmit} disabled={submitting}>
                    {submitting ? <ActivityIndicator size="small" color={theme.colors.white} /> : <Text style={styles.submitButtonText}>Update Product</Text>}
                </TouchableOpacity>
