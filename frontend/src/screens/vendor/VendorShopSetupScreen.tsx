...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, TextInput, Image, Switch, ActivityIndicator, Alert } from "react-native";
...
const VendorShopSetupScreen: React.FC = () => {
    ...
    const geocodeAddress = async () => {
        try {
            ...
            if (!form.address.street || !form.address.village || !form.address.district || !form.address.state || !form.address.pincode) {
    ...
    const handleInputChange = (field: keyof ShopFormState, value: string | boolean | LocationType) => {
        setForm({
            ...form,
            [field]: value,
        });
    ...
    const handleSave = async () => {
        try {
            // Validate form data
            if (!form.name || !form.description || !form.address.village || !form.address.street || !form.address.district || !form.address.state || !form.address.pincode || !form.address.phone) {
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.errorContainer}>
                    ...
                    <TouchableOpacity style={styles.retryButton} onPress={() => navigation.replace("VendorShopSetup")}>
                ...
                <>
                    <Card3D style={styles.formCard}>
                        ...
                        <View style={styles.formGroup}>
                            ...
                            <TextInput style={styles.input} placeholder="Enter shop name" value={form.name} onChangeText={(value) => handleInputChange("name", value)} />
                        </View>
                        ...
                        <View style={styles.formGroup}>
                            ...
                            <TextInput style={styles.input} placeholder="Enter image URL" value={form.image} onChangeText={handleImageUrlChange} />
                            ...
                            {form.image ? (
                                <View style={styles.imagePreviewContainer}>
                                    <Image
                                        ...
                                        onError={() => {
                                            Alert.alert("Invalid Image", "The image URL provided is invalid or inaccessible. Please check the URL and try again.");
                                        }}
                                    />
                                    <Text style={styles.imagePreviewLabel}>Image Preview</Text>
                                </View>
                            ) : (
                                <Text style={styles.helperText}>Enter a valid image URL to display your shop logo/image</Text>
                            )}
                        </View>
                        ...
                        <View style={styles.formGroup}>
                            ...
                            <Text style={styles.helperText}>When active, your shop will be visible to customers</Text>
                        </View>
                        ...
                        <View style={styles.formGroup}>
                            ...
                            <TextInput style={styles.input} placeholder="Enter street address" value={form.address.street} onChangeText={(value) => handleAddressChange("street", value)} />
                        </View>

                        <View style={styles.formGroup}>
                            <Text style={styles.label}>Village/Town *</Text>
                            <TextInput style={styles.input} placeholder="Enter village or town" value={form.address.village} onChangeText={(value) => handleAddressChange("village", value)} />
                        </View>

                        <View style={styles.formGroup}>
                            <Text style={styles.label}>District *</Text>
                            <TextInput style={styles.input} placeholder="Enter district" value={form.address.district} onChangeText={(value) => handleAddressChange("district", value)} />
                        </View>

                        <View style={styles.formGroup}>
                            <Text style={styles.label}>State *</Text>
                            <TextInput style={styles.input} placeholder="Enter state" value={form.address.state} onChangeText={(value) => handleAddressChange("state", value)} />
                        </View>
                        ...
                        <View style={styles.mapSection}>
                            ...
                            <Text style={styles.helperText}>We'll use your address to place your shop on the map. You can adjust the pin if needed.</Text>

                            <View style={styles.buttonRow}>
                                <Button title="Geocode Address" onPress={geocodeAddress} loading={locationLoading} style={styles.geocodeButton} />

                                <Button title={showMap ? "Hide Map" : "Show Map"} onPress={() => setShowMap(!showMap)} outline style={styles.toggleMapButton} />
                            </View>
                            ...
                            {showMap && (
                                <View style={styles.mapContainer}>
                                    ...
                                    <Text style={styles.mapNote}>Tap on the map to adjust the shop location pin</Text>
                                </View>
                            )}
                        </View>
                        ...
                        <Card3D style={styles.card}>
                            ...
                            <View style={styles.formGroup}>
                                ...
                                <TextInput
                                    ...
                                    keyboardType="decimal-pad"
                                />
                                <Text style={styles.helperText}>Orders above this amount will have free shipping</Text>
                            </View>
                        ...
                        <View style={styles.buttonContainer}>
                            <Button title="Save Shop Settings" onPress={handleSave} loading={saving} style={styles.saveButton} />
                        </View>
                    </Card3D>
                </>
            )}
