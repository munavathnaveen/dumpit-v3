...
const CheckoutScreen: React.FC = () => {
    ...
    const renderAddressItem = (address: Address, index: number) => (
        <TouchableOpacity key={address._id} style={[styles.addressItem, selectedAddress?._id === address._id && styles.selectedAddressItem]} onPress={() => setSelectedAddress(address)}>
    ...
    const renderPaymentMethodItem = (method: string, label: string, icon: React.ReactNode) => (
        <TouchableOpacity style={[styles.paymentItem, paymentMethod === method && styles.selectedPaymentItem]} onPress={() => setPaymentMethod(method)}>
            <View style={styles.paymentIconContainer}>{icon}</View>
            <Text style={styles.paymentLabel}>{label}</Text>
            {paymentMethod === method && <Ionicons name="checkmark-circle" size={20} color="#00C853" style={styles.paymentCheck} />}
        </TouchableOpacity>
    );
    ...
    return (
        <View style={styles.container}>
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.section}>
                    <View style={styles.sectionHeader}>
                        ...
                        <TouchableOpacity style={styles.addButton} onPress={() => navigation.navigate("Profile", { initialTab: "addresses" })}>
                    ...
                    {addresses.length === 0 ? (
                        <View style={styles.emptyAddressContainer}>
                            ...
                            <TouchableOpacity style={styles.addAddressButton} onPress={() => navigation.navigate("Profile", { initialTab: "addresses" })}>
                ...
                <View style={styles.section}>
                    ...
                    {couponApplied ? (
                        <View style={styles.appliedCouponContainer}>
                            <View style={styles.appliedCouponContent}>
                                ...
                                <View style={styles.appliedCouponInfo}>
                                    ...
                                    <Text style={styles.appliedCouponValue}>Discount: {formatCurrency(couponDiscount)}</Text>
                                </View>
                            </View>
                        ...
                        <View style={styles.couponInputContainer}>
                            <TextInput style={styles.couponInput} placeholder="Enter coupon code" value={couponCode} onChangeText={setCouponCode} autoCapitalize="characters" />
                            <TouchableOpacity style={styles.applyCouponButton} onPress={handleApplyCoupon} disabled={loading}>
                                {loading ? <ActivityIndicator size="small" color="#fff" /> : <Text style={styles.applyCouponButtonText}>Apply</Text>}
                            </TouchableOpacity>
                        </View>
                    )}
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.paymentMethodsContainer}>
                        {renderPaymentMethodItem("razorpay", "Razorpay", <FontAwesome5 name="credit-card" size={24} color="#072654" />)}
                        {renderPaymentMethodItem("cash_on_delivery", "Cash on Delivery", <MaterialIcons name="attach-money" size={24} color="#00C853" />)}
                    </View>
                </View>
            ...
            <View style={styles.bottomBar}>
                ...
                <TouchableOpacity style={styles.placeOrderButton} onPress={handlePlaceOrder} disabled={loading || addresses.length === 0}>
                    {loading ? (
