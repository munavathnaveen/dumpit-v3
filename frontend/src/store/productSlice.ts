...
export const getProducts = createAsyncThunk("product/getProducts", async (filters: ProductFilters = {}, { rejectWithValue }) => {
    try {
        let queryString = "";
...
export const getProduct = createAsyncThunk("product/getProduct", async (productId: string, { rejectWithValue }) => {
    try {
...
export const getProductsByShop = createAsyncThunk("product/getProductsByShop", async (shopId: string, { rejectWithValue }) => {
    try {
...
export const searchProducts = createAsyncThunk("product/searchProducts", async (searchTerm: string, { rejectWithValue }) => {
    try {
