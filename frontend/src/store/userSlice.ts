...
export const fetchNotifications = createAsyncThunk("user/fetchNotifications", async (userId: string, { rejectWithValue }) => {
    try {
...
export const markNotificationRead = createAsyncThunk("user/markNotificationRead", async ({ userId, notificationId }: { userId: string; notificationId: string }, { rejectWithValue }) => {
    try {
...
export const updateNotificationSettings = createAsyncThunk(
    ...
    async ({ userId, settings }: { userId: string; settings: { email?: boolean; push?: boolean } }, { rejectWithValue }) => {
        try {
...
export const addAddress = createAsyncThunk("user/addAddress", async (addressData: AddressRequest, { rejectWithValue }) => {
    try {
...
export const updateAddress = createAsyncThunk("user/updateAddress", async ({ addressId, addressData }: { addressId: string; addressData: AddressRequest }, { rejectWithValue }) => {
    try {
...
export const removeAddress = createAsyncThunk("user/removeAddress", async (addressId: string, { rejectWithValue }) => {
    try {
...
const userSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(markNotificationRead.fulfilled, (state, action: PayloadAction<{ notificationId: string; data: Notification }>) => {
                state.loading = false;
