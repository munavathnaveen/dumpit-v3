...
export const login = createAsyncThunk("auth/login", async (userData: LoginRequest, { rejectWithValue, dispatch }) => {
    try {
...
export const forgotPassword = createAsyncThunk("auth/forgotPassword", async (email: ForgotPasswordRequest, { rejectWithValue }) => {
    try {
