        ...
        return (
            <Card3D style={styles.card}>
                <View style={styles.noTrackingContainer}>
                    ...
                    <Text style={styles.noTrackingText}>Tracking information not available yet</Text>
                </View>
            </Card3D>
        );
    }
        ...
        <Card3D style={styles.card}>
            <View style={styles.headerContainer}>
                <View style={styles.statusIconContainer}>
                    <FontAwesome name={getStatusIcon(trackingData.tracking.status)} size={20} color={theme.colors.white} />
                </View>
