...
const VendorLocationHeader: React.FC<VendorLocationHeaderProps> = ({ title = "Location", showBackButton = false, onNotificationPress, rightIcon, onRightPress }) => {
            ...
            try {
                ...
                try {
                    ...
                    if (geocodeResult && geocodeResult.length > 0) {
                        ...
                        const locationString = [address.district, address.city, address.region].filter(Boolean).slice(0, 2).join(", ");
    ...
    const customLocation = (
        <TouchableOpacity style={styles.locationContainer} onPress={handleRefreshLocation} disabled={isLoading}>
